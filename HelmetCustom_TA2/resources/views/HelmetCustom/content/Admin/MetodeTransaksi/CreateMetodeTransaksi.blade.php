...
<head>
    ...
    <title>File Upload Metode Transaksi</title>
...
<body>
    ...
    <div class="container mt-3">
        <h2>Isi Data Metode Transaksi</h2>
        <hr>
        <form action="{{ route('metodetransaksi.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="metode_transaksi">Pilihan Metode Transaksi</label>
                <input type="text" class="form-control" id="metode_transaksi" name="metode_transaksi" >
