...
<head>
    ...
    <title>File Edit Pilihan Warna</title>
...
<body>
    ...
    <div class="container mt-3">
        <h2>Edit Data Warna</h2>
        <hr>
        <form action="{{ route('warna.update',$warna->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="form-group">
                <label for="warna">Pilihan Warna</label>
